            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Data Profil Risiko</h3>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Profil Risiko</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="merged" colspan="5" style="text-align: center;">TARGET PENURUNAN RISIKO</th>
                                                            <th>Tindakan</th>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="13"></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            name="fname" placeholder="Input Nama PJ"></td>
                                                            <td>otomatis</td>
                                                            <td>otomatis</td>
                                                            <td>otomatis</td>
                                                            <td>otomatis</td>
                                                            <td>otomatis</td>
                                                            <td>                                           
                                                                <a href="javascript:void(0);" onclick="showPopup()">Ubah PJ</a>
    ...
    <div class="popup" id="popup">
        <h2>Input Penanggung Jawab</h2>
        <input type="text" id="first-name" class="form-control" name="fname" placeholder="Input Nama PJ">
        <div>
